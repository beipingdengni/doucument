...
> https://github.com/yyxx1997/pytorch/blob/master/bert-sst2/readme.md 

基于BERT实现简单的[NER](https://so.csdn.net/so/search?q=NER&spm=1001.2101.3001.7020)任务
-------------------------------------------------------------------------------
...
[命名实体识别](https://so.csdn.net/so/search?q=%E5%91%BD%E5%90%8D%E5%AE%9E%E4%BD%93%E8%AF%86%E5%88%AB&spm=1001.2101.3001.7020)（Named Entity Recognition，简称NER），又称作“专名识别”，是指识别文本中具有特定意义的实体，主要包括人名、地名、机构名、专有名词等。作用命名实体识别是信息提取、问答系统、句法分析、机器翻译、面向Semantic Web的元数据标注等应用领域的重要基础工具，在自然语言处理技术走向实用化的过程中占有重要地位。
...
*   collate\_fn : 传入一个处理数据的回调函数

**DataLoader工作流程：**

1.  先从dataset中取出batch\_size个数据
...
模型整体效果图如下（图片来源：网络）：  
![BERT-NER](https://i-blog.csdnimg.cn/blog_migrate/4e69b251760cad067ccd715f36d3f3c8.png#pic_center)
